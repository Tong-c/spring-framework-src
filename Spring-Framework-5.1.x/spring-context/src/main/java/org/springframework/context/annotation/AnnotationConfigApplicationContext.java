...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		// 初始化注解模式下的bean定义信息读取器
		this.reader = new AnnotatedBeanDefinitionReader(this);
		// 初始化classpath下的bean定义信息扫描器
	...
	public AnnotationConfigApplicationContext(Class<?>... componentClasses) {
		// 创建了两个对象：AnnotatedBeanDefinitionReader、ClassPathBeanDefinitionScanner
		// 默认先调用父类（GenericApplicationContext）的无参构造函数，为ApplicationContext上下文对象初始beanFactory = new DefaultListableBeanFactory()
		this();
		// 注册注解扫描的配置信息
	...
	public void register(Class<?>... componentClasses) {
		...
		// 通过AnnotatedBeanDefinitionReader注册bean定义信息
