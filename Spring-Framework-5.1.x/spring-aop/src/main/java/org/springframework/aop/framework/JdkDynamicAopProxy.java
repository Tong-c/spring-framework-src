...
final class JdkDynamicAopProxy implements AopProxy, InvocationHandler, Serializable {
	...
	public Object getProxy(@Nullable ClassLoader classLoader) {
		...
		// 2、检查上一步获取的接口有没有定义equals()或者hashcode()方法
		findDefinedEqualsAndHashCodeMethods(proxiedInterfaces);
		// 3、传入通过classLoader、接口、InvocationHandler实现类，然后调用Proxy.newProxyInstance生成具体的代理对象(JDK动态代理)
		// public static Object newProxyInstance(ClassLoader loader, Class<?>[] interfaces, InvocationHandler h)
		// JdkDynamicAopProxy类实现了InvocationHandler接口，所以生成的代理对象的方法调用都会委托到InvocationHandler.invoke()方法中
